...
export const NAV_LINKS = {
  [Role.STUDENT]: [
    ...
    { name: 'Assignments', href: '/assignments', icon: <ClipboardIcon /> },
  ...
  [Role.TEACHER]: [
    ...
    { name: 'Courses', href: '/courses', icon: <BookOpenIcon /> },
    { name: 'Assignments', href: '/assignments', icon: <ClipboardIcon /> },
    { name: 'Mark Management', href: '/admin/mark-management', icon: <FileTextIcon /> },
    { name: 'Profile', href: '/profile', icon: <UserIcon /> },
    { name: 'Notifications', href: '/notifications', icon: <BellIcon /> },
  ],
  [Role.ADMIN]: [
    ...
    { name: 'Manage Courses', href: '/admin/manage-courses', icon: <EditIcon /> },
    { name: 'Create Course', href: '/admin/create-course', icon: <PlusCircleIcon /> },
    { name: 'Mark Management', href: '/admin/mark-management', icon: <FileTextIcon /> },
    { name: 'Profile', href: '/profile', icon: <UserIcon /> },
  ],
};
